...
def main():
    ...
    parser.add_argument(
        "--wandb-entity", type=str, help="Wandb entity (username or team)"
    )
    parser.add_argument("--experiment-name", type=str, help="Experiment name")
    parser.add_argument(
        "--resume", type=str, help="Resume wandb run (run ID or 'allow')"
    )
    ...
    cmd_parts = [
        ...
        "scripts/train.py",
        "--config",
        "configs/training/wandb.yaml",  # Use wandb-specific config
        "--model-config",
